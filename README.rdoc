...
This is perhaps not the smartest way to process Facebook logins, but it does seem to get the job done. I think I'll try refactoring next however, or rethinking this whole use of authlogic. Plus, profile merging is still bugging me.
